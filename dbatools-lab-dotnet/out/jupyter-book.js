...
const findCorrectFolder = (folderName, rootExtensionsFolder) => {
    ...
    if (folderExt.indexOf(('RobSewell.dbatools-lab-dotnet').toLowerCase()) > -1) {
...
// This function is called when you run the command `Launch Book: dbatools-lab-dotnet` from
...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('launchBook.dbatools-lab-dotnet', () => {
        processNotebooks();
    }));
}
